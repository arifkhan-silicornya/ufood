              ...
              <div>
                <table class="table align-items-center">
                  ...
                  <tbody class="list">
                    ...
                    @endphp
                    @if ($manager->institute_name == $users->instituteName)
                    <tr>
                      {{-- <th scope="row">
                      ...
                      <td class="text-right">
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                            <a class="dropdown-item" href="{{ url('/managerConfirmOrder?orderid='.$row->id) }}">Confirm</a>
                            <a class="dropdown-item" href="{{ url('/managerCancelOrder?orderid='.$row->id) }}">Cancel</a>
