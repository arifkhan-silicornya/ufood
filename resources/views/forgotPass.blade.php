          ...
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-body px-lg-5 py-lg-5">
              <div class="text-center text-muted mb-4">
                <p class="text-danger font-weight-bold">Enter Your E-mail. We will send you a verification link to your mail.</p>
              </div>
              <form role="form" action="/recoverySendMail" method="POST">
                @csrf
                ...
                <div class="form-group mb-3">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control" placeholder="User Your E-mail Address " type="email" name="userMail" required>
                  </div>
                </div>
